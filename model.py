...
def model_result(law_title: str=sys.argv[1]):
    ...
    for lid, value in sims:
        ...
        one_dict = {
            "law_id": one_lid_series["법령ID"],
            "law_title": one_lid_series["법령명한글"],
            "law_url": one_lid_series["법령상세링크"],
            "law_short_title": one_lid_series["법령약칭명"],
            "law_raw_id": one_lid_series["법령일련번호"],
            "law_make_date": one_lid_series["공포일자"],
            "law_org_code": one_lid_series["소관부처코드"],
            "law_org_name": one_lid_series["소관부처명"],
            "law_kind": one_lid_series["법령구분명"],
            "law_start_date": one_lid_series["시행일자"]
        }
